    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            try:
                ...
                print(f"Failed to identify image {image_file}. Using a placeholder.")
                return None
        ...
        if isinstance(i, int):
            preprocess_result = {key: val[0] for key, val in preprocess_result.items()}
            
        data_dict.update(preprocess_result)
        return data_dict
